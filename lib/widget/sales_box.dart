...
class SalesBox extends StatelessWidget {
  ...
  _items(BuildContext context) {
    ...
    items.add(
        _doubleItem(context, salesBox.smallCard1, salesBox.smallCard1, false, false)
    );
    items.add(
  ...
  Widget _item(BuildContext context, CommonModel model, bool isBig, bool left, bool last) {
